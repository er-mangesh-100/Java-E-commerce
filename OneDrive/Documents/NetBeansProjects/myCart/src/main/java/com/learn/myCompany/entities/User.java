...
@Entity //comes from java.persistant
public class User {
    @Id //primary key
    @GeneratedValue(strategy = GenerationType.IDENTITY) //autoincrement hoga userid!
     @Column(length = 10,name = "user_id") //userid ka length!
    private int userId;
    ...
    @Column(length = 1500,name = "user_address") //length of address but ab banega user_address k naam se 
