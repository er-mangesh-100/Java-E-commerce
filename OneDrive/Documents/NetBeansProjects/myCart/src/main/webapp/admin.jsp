...
<%@page import="com.learn.myCompany.entities.User" %>           
...
<html>
    ...
    <body>
        ...
        <div class="container admin mt-4"> 
            ...
            <div container="container-fluid mt-3">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            <div class="container">
                                <img style="max-width: 125px;"  class="img-fluid rounded-circle" src="img/product.png" alt="products_icon"/>
                            </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card" data-toggle="modal" data-target="#add-category-modal">
                        <div class="card-body text-center">
                            <div class="container">
                                <img style="max-width: 125px;"  class="img-fluid rounded-circle" src="img/keys.png" alt="category_icon"/>
                            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card" data-toggle="modal" data-target="#add-product-modal">
                        <div class="card-body text-center">
                            <div class="container">
                                <img style="max-width: 125px;"  class="img-fluid rounded-circle" src="img/plus.png" alt="products_icon"/>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="ProductOperationServlet" method="post">
                            ...
                            <input type="hidden" name="operation" value="addcategory"> <!<!-- this will tell to my servlet that category ka le raha ya product ka form! -->
                            ...
                            <div class="container text-center">
                                ...
                                <button  id="butt" type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            </div>
                        </form>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="ProductOperationServlet" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <!--<!-- category of product comes from database --> 
