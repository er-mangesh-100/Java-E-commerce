                ...
                <div class="col-md-6">
                    ...
                    <div class="card" style="background-color: lightblue">
                        <div class="card-body">
                           ...
                           <h3 class="text-center mb-5 my-3" style="color: darkblue">Your selected items!</h3>
                        <div class="cart-body">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card" style="background-color: lightblue">
                        <div class="card-body">
                           ...
                           <h3 class="text-center mb-5 my-3" style="color: darkblue">Your details for order!</h3>
                           <form action="#!">
